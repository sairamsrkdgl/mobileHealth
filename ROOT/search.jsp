...
<html>
	...
	<META HTTP-EQUIV="refresh" CONTENT="<%= session.getMaxInactiveInterval() %>; sexpire.jsp" />
        <title>MOBILE HEALTH :: LIST OF ASSIGNED PATIENTS</title>
    </head>
    <body>
    <%@include file="head.html"%>
    <h2>Assigned Patients</h2><br/>
    <%
    out.print("Welcome:"+session.getAttribute("sUserName"));
    %><br/>
    <%@include file="doctormenu.html"%><br/>
   ...
   //       String toage = request.getParameter("toage");
       ...
       <%
         for ( Patient p : patients) {
              ...
              out.println("<td><a href=download.jsp?pid=" + p.getId() + ">Download</a></td>");
              out.println("</tr>");
         }
         out.println("</table>");
       }// else
