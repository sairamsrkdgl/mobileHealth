...
<html>
    ...
    <%
      ...
      String pipaddress = request.getParameter("pip_f");
      boolean done = false;
      ...
      if ( address == null)  {
           ...
           pname = p.getPname();
           pipaddress = p.getPatientip();
      }
      else {
           done = Patient.update(patient_id,contactno,address,pipaddress);
           if (! done )
...
%>         
    <form action="updatepatient.jsp" method="post">
        <table>
            ...
            <tr>
                <td>Camera IP </td>
                <td><input type=text size=20 name=pip_f value='<%=pipaddress%>' </td>
            </tr>
